...
{
    vector<vector<vector<int>>> dp(n, vector<vector<int>>(2, vector<int>(3,-1)));  //since we have two changing paramerters- index, bought.
    return solve(false, 0, prices,n, dp, 2);
}